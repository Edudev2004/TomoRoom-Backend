...
async function resolveEmbedUrl(url, parentUrl = null) {
  ...
  const isProtectedSite = /wish|playnix|medix|niramirus|kravaxxa|davioad|haxlopp|tryzendm|dumbalag|dhcplay|hglink|vidhide|voe|mixdrop|dood|dropload|dr0pstream|drop\.download/i.test(host);
  if (isProtectedSite) {
